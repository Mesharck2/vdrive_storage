  ...
  return (
    <header className='mobile-header'>
      <Image src="/assets/icons/logo-full-brand.svg" alt='logo'
       width={120} height={52} className='h-auto' />
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent className='shad-sheet h-screen px-3'>
            ...
            <nav className="mobile-nav">
              <ul className="mobile-nav-list">
                {navItems.map(({url, name, icon}) => (
                  ...
                  <Link onClick={()=>setOpen(false)} key={name} href={url} className='lg:w-full'>
            ...
            <div className='flex flex-col justify-center gap-5 pb-5'>
                ...
                <Button onClick={async () => await signOutUser()} type='submit'

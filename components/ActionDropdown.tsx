...
const ActionDropdown = ({ file } : { file: Models.Document }) => {
    ...
    const fileWithoutExt = file.name.split(".").slice(0, -1).join('.');
    // console.log(fileWithoutExt)
    
    const [name, setName] = useState(fileWithoutExt);
    ...
    <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DropdownMenu open={isDropdownOpen} onOpenChange={setIsDropdownOpen}>
            ...
            <DropdownMenuContent>
                ...
                {actionsDropdownItems.map((actionItem, index) => (
                    <DropdownMenuItem className='shad-dropdown-item' key={index} onClick={()=> { 
